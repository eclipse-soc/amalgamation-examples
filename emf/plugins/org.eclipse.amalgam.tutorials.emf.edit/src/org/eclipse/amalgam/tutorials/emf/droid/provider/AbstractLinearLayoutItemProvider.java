...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.tutorials.emf.droid.AbstractLinearLayout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractLinearLayoutItemProvider
	 ...
	 * @generated
	 */
	public AbstractLinearLayoutItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractLinearLayout_orientation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractLinearLayout_orientation_feature", "_UI_AbstractLinearLayout_type"),
				 DroidPackage.eINSTANCE.getAbstractLinearLayout_Orientation(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns AbstractLinearLayout.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AbstractLinearLayout"));
	}
	...
	public String getText(Object object) {
		String label = ((AbstractLinearLayout)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractLinearLayout_type") :
			getString("_UI_AbstractLinearLayout_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractLinearLayout.class)) {
