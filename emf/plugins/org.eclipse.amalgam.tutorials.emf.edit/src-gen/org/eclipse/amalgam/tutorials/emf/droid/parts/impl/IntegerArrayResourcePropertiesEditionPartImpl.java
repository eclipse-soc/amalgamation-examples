 ...
 * 
 */
public class IntegerArrayResourcePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, IntegerArrayResourcePropertiesEditionPart {
	 ...
	 * 
	 */
	public IntegerArrayResourcePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(DroidMessages.IntegerArrayResourcePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.IntegerArrayResourcePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.IntegerArrayResource.Properties.name, DroidViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerArrayResourcePropertiesEditionPartImpl.this, DroidViewsRepository.IntegerArrayResource.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.IntegerArrayResource.Properties.name, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createItemsMultiValuedEditor(Composite parent) {
		...
		editItems.setText(DroidMessages.IntegerArrayResourcePropertiesEditionPart_ItemsLabel);
		...
		editItems.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(IntegerArrayResourcePropertiesEditionPartImpl.this, DroidViewsRepository.IntegerArrayResource.Properties.items, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(itemsList)));
					setHasChanged(true);
				}
			}
		});
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.IntegerArrayResourcePropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.IntegerArrayResourcePropertiesEditionPart#setName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.IntegerArrayResourcePropertiesEditionPart#getItems()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.IntegerArrayResourcePropertiesEditionPart#setItems(EList newValue)
	 * 
	 */
