...
import droid.parts.ScaleAnimationPropertiesEditionPart;
 ...
 * 
 */
public class ScaleAnimationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ScaleAnimationPropertiesEditionPart {
	 ...
	 * 
	 */
	public ScaleAnimationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(DroidMessages.ScaleAnimationPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createFromAlphaText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.ScaleAnimationPropertiesEditionPart_FromAlphaLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.ScaleAnimation.Properties.fromAlpha, DroidViewsRepository.FORM_KIND));
		...
		fromAlpha.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScaleAnimationPropertiesEditionPartForm.this, DroidViewsRepository.ScaleAnimation.Properties.fromAlpha, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fromAlpha.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.ScaleAnimation.Properties.fromAlpha, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createToAlphaText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.ScaleAnimationPropertiesEditionPart_ToAlphaLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.ScaleAnimation.Properties.toAlpha, DroidViewsRepository.FORM_KIND));
		...
		toAlpha.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScaleAnimationPropertiesEditionPartForm.this, DroidViewsRepository.ScaleAnimation.Properties.toAlpha, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, toAlpha.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.ScaleAnimation.Properties.toAlpha, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ScaleAnimationPropertiesEditionPart#getFromAlpha()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ScaleAnimationPropertiesEditionPart#setFromAlpha(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ScaleAnimationPropertiesEditionPart#getToAlpha()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ScaleAnimationPropertiesEditionPart#setToAlpha(String newValue)
	 * 
	 */
