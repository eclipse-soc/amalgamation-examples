...
public class ButtonPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ButtonPropertiesEditionPart {
	...
	protected Composite createTargetFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.ButtonPropertiesEditionPart_TargetLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.Button.Properties.target, DroidViewsRepository.SWT_KIND));
		target = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.Button.Properties.target, DroidViewsRepository.SWT_KIND));
		target.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		target.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ButtonPropertiesEditionPartImpl.this, DroidViewsRepository.Button.Properties.target, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTarget()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.Button.Properties.target, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
