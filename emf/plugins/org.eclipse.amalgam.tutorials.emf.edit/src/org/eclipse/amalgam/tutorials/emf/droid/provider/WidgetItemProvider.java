...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.tutorials.emf.droid.Widget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WidgetItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_LayoutParams());
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_Top());
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_Left());
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_Width());
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_Height());
			childrenFeatures.add(DroidPackage.eINSTANCE.getWidget_Clickable());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_LayoutParams(),
				 DroidFactory.eINSTANCE.createLayoutParams()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_Top(),
				 DroidFactory.eINSTANCE.createDimensionVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_Left(),
				 DroidFactory.eINSTANCE.createDimensionVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_Width(),
				 DroidFactory.eINSTANCE.createDimensionVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_Height(),
				 DroidFactory.eINSTANCE.createDimensionVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getWidget_Clickable(),
