 ...
 * 
 */
public interface MenuResourcePropertiesEditionPart {
	 ...
	 * @param newValue the menuItems to update
	 * 
	 */
	public void updateMenuItems();

	/**
	 * Adds the given filter to the menuItems edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the menuItems table
	 * 
	 */
	...
	/**
	 * Update the groups
	 * @param newValue the groups to update
	 * 
	 */
	public void updateGroups();

	/**
	 * Adds the given filter to the groups edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the groups table
	 * 
	 */
