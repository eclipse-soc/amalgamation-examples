 ...
 * <ul>
 *   <li>{@link droid.impl.TabImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getName <em>Name</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getSelectedIcon <em>Selected Icon</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link droid.impl.TabImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
