 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.PropertyValueImpl#getExternalResource <em>External Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyValueImpl extends MinimalEObjectImpl.Container implements PropertyValue
{
  ...
  {
    return DroidPackage.Literals.PROPERTY_VALUE;
  }
  ...
  public void setExternalResource(String newExternalResource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.PROPERTY_VALUE__EXTERNAL_RESOURCE, oldExternalResource, externalResource));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DroidPackage.PROPERTY_VALUE__EXTERNAL_RESOURCE:
