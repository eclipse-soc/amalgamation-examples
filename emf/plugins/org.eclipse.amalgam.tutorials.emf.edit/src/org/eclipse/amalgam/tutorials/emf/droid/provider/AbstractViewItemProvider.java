...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.tutorials.emf.droid.AbstractView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractView_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractView_name_feature", "_UI_AbstractView_type"),
				 DroidPackage.eINSTANCE.getAbstractView_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.eINSTANCE.getAbstractView_Widgets());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getAbstractView_Widgets(),
