 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.GenericActivityImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GenericActivityImpl extends ActivityImpl implements GenericActivity
{
  ...
  {
    return DroidPackage.Literals.GENERIC_ACTIVITY;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, DroidPackage.GENERIC_ACTIVITY__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroidPackage.GENERIC_ACTIVITY__ACTIONS:
