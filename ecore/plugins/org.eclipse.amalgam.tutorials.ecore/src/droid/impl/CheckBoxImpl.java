 ...
 * <ul>
 *   <li>{@link droid.impl.CheckBoxImpl#getName <em>Name</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getText <em>Text</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getTop <em>Top</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getClickable <em>Clickable</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getFadeScrollBars <em>Fade Scroll Bars</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getIsScrollContainer <em>Is Scroll Container</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getAutoLink <em>Auto Link</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getAutoText <em>Auto Text</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getCapitalize <em>Capitalize</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getDigits <em>Digits</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getEditable <em>Editable</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getGravity <em>Gravity</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getHint <em>Hint</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getNumeric <em>Numeric</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getPhoneNumber <em>Phone Number</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getSingleLine <em>Single Line</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getTextColor <em>Text Color</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getTypeface <em>Typeface</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getTextSize <em>Text Size</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getTextStyle <em>Text Style</em>}</li>
 *   <li>{@link droid.impl.CheckBoxImpl#getOnCheck <em>On Check</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
