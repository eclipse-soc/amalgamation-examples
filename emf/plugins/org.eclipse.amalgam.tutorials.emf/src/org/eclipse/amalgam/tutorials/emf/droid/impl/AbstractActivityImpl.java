 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.emf.droid.impl.AbstractActivityImpl#getReferencedLayout <em>Referenced Layout</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.emf.droid.impl.AbstractActivityImpl#getWidgets <em>Widgets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AbstractActivityImpl extends EObjectImpl implements AbstractActivity {
	/**
	...
	protected EClass eStaticClass() {
		return DroidPackage.eINSTANCE.getAbstractActivity();
	}
		...
		if (referencedLayout != null && referencedLayout.eIsProxy()) {
			...
			if (referencedLayout != oldReferencedLayout) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.ABSTRACT_ACTIVITY__REFERENCED_LAYOUT, oldReferencedLayout, referencedLayout));
			}
		}
	...
	public void setReferencedLayout(Layout newReferencedLayout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.ABSTRACT_ACTIVITY__REFERENCED_LAYOUT, oldReferencedLayout, referencedLayout));
	}
	...
	public NotificationChain basicSetWidgets(ViewCollection newWidgets, NotificationChain msgs) {
		...
		widgets = newWidgets;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.ABSTRACT_ACTIVITY__WIDGETS, oldWidgets, newWidgets);
	...
	public void setWidgets(ViewCollection newWidgets) {
		if (newWidgets != widgets) {
			...
			if (widgets != null)
				msgs = ((InternalEObject)widgets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.ABSTRACT_ACTIVITY__WIDGETS, null, msgs);
			if (newWidgets != null)
				msgs = ((InternalEObject)newWidgets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.ABSTRACT_ACTIVITY__WIDGETS, null, msgs);
			msgs = basicSetWidgets(newWidgets, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.ABSTRACT_ACTIVITY__WIDGETS, newWidgets, newWidgets));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DroidPackage.ABSTRACT_ACTIVITY__WIDGETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroidPackage.ABSTRACT_ACTIVITY__REFERENCED_LAYOUT:
