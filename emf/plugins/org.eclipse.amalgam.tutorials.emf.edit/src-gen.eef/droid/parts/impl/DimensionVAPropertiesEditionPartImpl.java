...
public class DimensionVAPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DimensionVAPropertiesEditionPart {
	...
	protected Composite createConstant_valueEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.DimensionVAPropertiesEditionPart_Constant_valueLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.DimensionVA.Properties.constant_value, DroidViewsRepository.SWT_KIND));
		...
		constant_value.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DimensionVAPropertiesEditionPartImpl.this, DroidViewsRepository.DimensionVA.Properties.constant_value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getConstant_value()));
			}

		});
		constant_value.setID(DroidViewsRepository.DimensionVA.Properties.constant_value);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.DimensionVA.Properties.constant_value, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.DimensionVAPropertiesEditionPart#getConstant_value()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.DimensionVAPropertiesEditionPart#initConstant_value(EEnum eenum, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.DimensionVAPropertiesEditionPart#setConstant_value(Enumerator newValue)
	 * 
	 */
