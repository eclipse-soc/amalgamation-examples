 ...
 * <ul>
 *   <li>{@link droid.DrawableVA#getAccess <em>Access</em>}</li>
 * </ul>
 * </p>
 *
 * @see droid.DroidPackage#getDrawableVA()
 * @model
 * @generated
 */
public interface DrawableVA extends ValueAccess, AnyDrawableVA {
	 ...
	 * @see droid.DroidPackage#getDrawableVA_Access()
	...
	/**
	 * Sets the value of the '{@link droid.DrawableVA#getAccess <em>Access</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
