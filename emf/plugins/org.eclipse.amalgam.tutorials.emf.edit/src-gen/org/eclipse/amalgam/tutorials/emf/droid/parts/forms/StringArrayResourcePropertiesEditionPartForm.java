...
import org.eclipse.amalgam.tutorials.emf.droid.parts.StringArrayResourcePropertiesEditionPart;
 ...
 * 
 */
public class StringArrayResourcePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, StringArrayResourcePropertiesEditionPart {
	 ...
	 * 
	 */
	public StringArrayResourcePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(DroidMessages.StringArrayResourcePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.StringArrayResourcePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.StringArrayResource.Properties.name, DroidViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StringArrayResourcePropertiesEditionPartForm.this, DroidViewsRepository.StringArrayResource.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.StringArrayResource.Properties.name, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createItemsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editItems = widgetFactory.createButton(parent, DroidMessages.StringArrayResourcePropertiesEditionPart_ItemsLabel, SWT.NONE);
		...
		editItems.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StringArrayResourcePropertiesEditionPartForm.this, DroidViewsRepository.StringArrayResource.Properties.items, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(itemsList)));
					setHasChanged(true);
				}
			}
		});
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.StringArrayResourcePropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.StringArrayResourcePropertiesEditionPart#setName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.StringArrayResourcePropertiesEditionPart#getItems()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.amalgam.tutorials.emf.droid.parts.StringArrayResourcePropertiesEditionPart#setItems(EList newValue)
	 * 
	 */
