 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getCaption <em>Caption</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getIcon <em>Icon</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getSelectedIcon <em>Selected Icon</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getActivity <em>Activity</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Tab extends EObject
{
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_Caption()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getCaption <em>Caption</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_Icon()
   * @model containment="true"
   * @generated
   */
  DrawableRA getIcon();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getIcon <em>Icon</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_SelectedIcon()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getSelectedIcon <em>Selected Icon</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_Layout()
   * @model
   * @generated
   */
  Layout getLayout();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.Tab#getLayout <em>Layout</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTab_Actions()
   * @model containment="true"
   * @generated
   */
