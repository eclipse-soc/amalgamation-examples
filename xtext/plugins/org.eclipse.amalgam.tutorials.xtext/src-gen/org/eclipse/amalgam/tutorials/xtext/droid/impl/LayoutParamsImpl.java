...
import org.eclipse.amalgam.tutorials.xtext.droid.IntegerVA;
import org.eclipse.amalgam.tutorials.xtext.droid.LayoutDimensionVA;
 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_height <em>Layout height</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_width <em>Layout width</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_weight <em>Layout weight</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_marginBottom <em>Layout margin Bottom</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_marginLeft <em>Layout margin Left</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_marginRight <em>Layout margin Right</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_marginTop <em>Layout margin Top</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_above <em>Layout above</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignBaseline <em>Layout align Baseline</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignBottom <em>Layout align Bottom</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignLeft <em>Layout align Left</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignParentBottom <em>Layout align Parent Bottom</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignParentLeft <em>Layout align Parent Left</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignParentRight <em>Layout align Parent Right</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignParentTop <em>Layout align Parent Top</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignTop <em>Layout align Top</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_alignWithParentIfMissing <em>Layout align With Parent If Missing</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_below <em>Layout below</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_centerHorizontal <em>Layout center Horizontal</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_centerInParent <em>Layout center In Parent</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_centerVertical <em>Layout center Vertical</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_toLeftOf <em>Layout to Left Of</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.impl.LayoutParamsImpl#getLayout_toRightOf <em>Layout to Right Of</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
