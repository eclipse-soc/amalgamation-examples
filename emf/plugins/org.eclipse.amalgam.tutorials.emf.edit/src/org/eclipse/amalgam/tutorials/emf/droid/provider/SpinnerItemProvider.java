...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.tutorials.emf.droid.Spinner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpinnerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.eINSTANCE.getSpinner_Prompt());
			childrenFeatures.add(DroidPackage.eINSTANCE.getSpinner_FadeScrollBars());
			childrenFeatures.add(DroidPackage.eINSTANCE.getSpinner_IsScrollContainer());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getSpinner_Prompt(),
				 DroidFactory.eINSTANCE.createStringVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getSpinner_FadeScrollBars(),
				 DroidFactory.eINSTANCE.createBooleanVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getSpinner_IsScrollContainer(),
				 DroidFactory.eINSTANCE.createBooleanVA()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DroidPackage.eINSTANCE.getSpinner_FadeScrollBars() ||
			childFeature == DroidPackage.eINSTANCE.getSpinner_IsScrollContainer();
