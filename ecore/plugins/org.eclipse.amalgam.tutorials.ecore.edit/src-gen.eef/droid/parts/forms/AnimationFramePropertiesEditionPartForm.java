 ...
 * 
 */
public class AnimationFramePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AnimationFramePropertiesEditionPart {
	 ...
	 * 
	 */
	public AnimationFramePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(DroidMessages.AnimationFramePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createDurationText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.AnimationFramePropertiesEditionPart_DurationLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.AnimationFrame.Properties.duration, DroidViewsRepository.FORM_KIND));
		...
		duration.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnimationFramePropertiesEditionPartForm.this, DroidViewsRepository.AnimationFrame.Properties.duration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, duration.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.AnimationFrame.Properties.duration, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
