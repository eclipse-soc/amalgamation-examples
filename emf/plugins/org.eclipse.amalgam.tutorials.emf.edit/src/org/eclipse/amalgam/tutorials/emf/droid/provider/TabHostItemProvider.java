...
/**
 * This is the item provider adapter for a {@link org.eclipse.amalgam.tutorials.emf.droid.TabHost} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TabHostItemProvider
	 ...
	 * @generated
	 */
	public TabHostItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.eINSTANCE.getTabHost_LayoutParams());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TabHost"));
	}
	...
	public String getText(Object object) {
		String label = ((TabHost)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TabHost_type") :
			getString("_UI_TabHost_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TabHost.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getTabHost_LayoutParams(),
