...
public class ApplicationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ApplicationPropertiesEditionPart {
		...
		composer = new PartComposer(applicationStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == DroidViewsRepository.Application.Properties.activities) {
					return createActivitiesTableComposition(widgetFactory, parent);
				}
	 ...
	 * 
	 */
	protected Composite createActivitiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.activities = new ReferencesTable(DroidMessages.ApplicationPropertiesEditionPart_ActivitiesLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPropertiesEditionPartForm.this, DroidViewsRepository.Application.Properties.activities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				activities.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPropertiesEditionPartForm.this, DroidViewsRepository.Application.Properties.activities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				activities.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPropertiesEditionPartForm.this, DroidViewsRepository.Application.Properties.activities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				activities.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPropertiesEditionPartForm.this, DroidViewsRepository.Application.Properties.activities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				activities.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.activities.setHelpText(propertiesEditionComponent.getHelpContent(DroidViewsRepository.Application.Properties.activities, DroidViewsRepository.FORM_KIND));
		this.activities.createControls(parent, widgetFactory);
		this.activities.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPropertiesEditionPartForm.this, DroidViewsRepository.Application.Properties.activities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ApplicationPropertiesEditionPart#initActivities(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ApplicationPropertiesEditionPart#updateActivities()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ApplicationPropertiesEditionPart#addFilterActivities(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ApplicationPropertiesEditionPart#addBusinessFilterActivities(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.ApplicationPropertiesEditionPart#isContainedInActivitiesTable(EObject element)
	 * 
	 */
