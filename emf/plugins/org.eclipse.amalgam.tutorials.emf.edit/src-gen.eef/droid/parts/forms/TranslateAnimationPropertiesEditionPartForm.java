...
import droid.parts.TranslateAnimationPropertiesEditionPart;
 ...
 * 
 */
public class TranslateAnimationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TranslateAnimationPropertiesEditionPart {
	 ...
	 * 
	 */
	public TranslateAnimationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(DroidMessages.TranslateAnimationPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createFromAlphaText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.TranslateAnimationPropertiesEditionPart_FromAlphaLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.TranslateAnimation.Properties.fromAlpha, DroidViewsRepository.FORM_KIND));
		...
		fromAlpha.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TranslateAnimationPropertiesEditionPartForm.this, DroidViewsRepository.TranslateAnimation.Properties.fromAlpha, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fromAlpha.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.TranslateAnimation.Properties.fromAlpha, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createToAlphaText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.TranslateAnimationPropertiesEditionPart_ToAlphaLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.TranslateAnimation.Properties.toAlpha, DroidViewsRepository.FORM_KIND));
		...
		toAlpha.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TranslateAnimationPropertiesEditionPartForm.this, DroidViewsRepository.TranslateAnimation.Properties.toAlpha, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, toAlpha.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.TranslateAnimation.Properties.toAlpha, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.TranslateAnimationPropertiesEditionPart#getFromAlpha()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.TranslateAnimationPropertiesEditionPart#setFromAlpha(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.TranslateAnimationPropertiesEditionPart#getToAlpha()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.TranslateAnimationPropertiesEditionPart#setToAlpha(String newValue)
	 * 
	 */
