...
/**
 * This is the item provider adapter for a {@link droid.RadioButton} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RadioButtonItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RadioButton_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RadioButton_name_feature", "_UI_RadioButton_type"),
				 DroidPackage.eINSTANCE.getRadioButton_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.eINSTANCE.getRadioButton_Text());
			childrenFeatures.add(DroidPackage.eINSTANCE.getRadioButton_OnClick());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getRadioButton_Text(),
				 DroidFactory.eINSTANCE.createStringVA()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.eINSTANCE.getRadioButton_OnClick(),
