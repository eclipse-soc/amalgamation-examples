 ...
 * <ul>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getGravity <em>Gravity</em>}</li>
 *   <li>{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getDivider <em>Divider</em>}</li>
 ...
 * </p>
 *
 * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget()
 * @model
 * @generated
 */
public interface TabWidget extends AbstractLinearLayout
{
   ...
   * The list contents are of type {@link org.eclipse.amalgam.tutorials.xtext.droid.LayoutGravityKind}.
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget_Gravity()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget_Divider()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getDivider <em>Divider</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget_TrabStripEnabled()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getTrabStripEnabled <em>Trab Strip Enabled</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget_TrabStripLeft()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getTrabStripLeft <em>Trab Strip Left</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.amalgam.tutorials.xtext.droid.DroidPackage#getTabWidget_TabStripRight()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.amalgam.tutorials.xtext.droid.TabWidget#getTabStripRight <em>Tab Strip Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
