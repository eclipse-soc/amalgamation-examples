...
public class DroidPackageImpl extends EPackageImpl implements DroidPackage {
	 ...
	 * @see org.eclipse.amalgam.tutorials.emf.droid.DroidPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("org.eclipse.amalgam.tutorials.emf.droid." + eClassifier.getName());
